							...
							<div className='bg-card/50 backdrop-blur-sm p-12 rounded-2xl border-2 border-foreground/10'>
								...
								<div className='space-y-4 text-lg text-card-foreground/80'>
									<p>
										...
										vekst verden over. Med våre 6 baner på Grini er vi de eneste
										i Oslo området som tilbyr både inne og utebaner.
									</p>
									<p>
										Vår visjon er å skape et levende padelfellesskap hvor
										spillere på alle nivåer kan utvikle seg og dele gleden ved
										sporten.
									</p>
								</div>
							</div>
					...
					{isLoading ? (
						<div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8'>
							{[...Array(2)].map((_, index) => (
								<div
									key={index}
									className='bg-card p-10 rounded-2xl border-2 border-foreground/10'
								>
						...
						>
							<motion.div
								...
								className='bg-card p-10 rounded-2xl border-2 border-foreground/10 group hover:bg-card/70 transition-all duration-500'
							>
								...
								<p className='text-lg text-card-foreground/80 group-hover:text-card-foreground'>
									...
									innen padelanlegg. Våre fasiliteter inkluderer også
									garderober, pro shop og sosiale områder.
								</p>
							</motion.div>
