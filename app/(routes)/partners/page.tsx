				...
				{isLoading ? (
					...
					>
						...
						<p className='text-lg md:text-2xl text-muted-foreground leading-relaxed'>
							Vi er stolte av å samarbeide med noen av verdens ledende
							merkevarer innen sport og livsstil. Sammen skaper vi bedre
							opplevelser for våre medlemmer.
						</p>
					</motion.div>
				)}
			</div>
					...
					{isLoading ? (
						<div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8'>
							{[...Array(2)].map((_, index) => (
								<div
									key={index}
									className='bg-card/50 backdrop-blur-sm p-10 rounded-2xl border-2 border-foreground/10'
								>
						...
						>
							...
							>
								...
								<p className='text-lg text-card-foreground/80 group-hover:text-card-foreground'>
									...
									kontakt med oss for en uforpliktende samtale om mulighetene
									for partnerskap.
								</p>
							</motion.div>
						</motion.div>
